...
from PyQt5.QtWidgets import QMainWindow, QWidget, QVBoxLayout, QPushButton, QLabel, QLineEdit, QTextEdit, QFileDialog, QMessageBox, QComboBox
...
class RAGAssistantApp(QMainWindow):
    ...
    def update_chat_display(self, message):
        # To ensure thread safety, use Qt's signal-slot mechanism
